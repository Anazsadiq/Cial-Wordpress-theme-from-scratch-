   ...
   <div class="services_section layout_padding">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4">
            <div><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-1.png" class="image_1"></div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="what_we_do_section_2">
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-1.png"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main active">
              <div class="icon_1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-2.png"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-3.png"></div>
          ...
          <div class="col-lg-3 col-sm-6">
            <div class="box_main">
              <div class="icon_1"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/icon-4.png"></div>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="project_main">
              ...
              <div class="moremore_bt"><a href="#">Read More </a></div>
              <div class="image_6"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-6.png"></div>
            </div>
          </div>
          <div class="col-md-6">
            <div class="images_main">
              <div class="images_left">
                <div class="container_1">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-2.png" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/search-icon.png"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
                </div>
                <div class="container_1">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-3.png" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/search-icon.png"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
              ...
              <div class="images_right">
                <div class="container_1">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-4.png" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/search-icon.png"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
                ...
                <div class="container_1">
                  <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-5.png" alt="Avatar" class="image" style="width:100%">
                  <div class="middle">
                    <div class="text"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/search-icon.png"></div>
                    <h2 class="fact_text">Established Fact</h2>
                  </div>
    ...
    <div class="team_section layout_padding">
      <div class="container">
        ...
        <div class="team_section_2 layout_padding">
          <div class="row">
            <div class="col-sm-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-7.png" class="image_7">
              ...
              <div class="social_icon">
                <ul>
                  ...
                  <li><a href="#"><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/linkedin-icon.png"></a></li>
                </ul>
              </div>
            </div>
            <div class="col-sm-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-8.png" class="image_7">
            ...
            <div class="col-sm-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-9.png" class="image_7">
              <p class="readable_text">Readable</p>
              <p class="readable_text_1">Follow Us</p>
              <div class="social_icon">
                <ul>
            ...
            <div class="col-sm-3">
              <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-10.png" class="image_7">
              <p class="readable_text">Content</p>
              <p class="readable_text_1">Follow Us</p>
              <div class="social_icon">
                <ul>
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              ...
              <div class="client_section_2 layout_padding">
                <ul>
                  <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/round-1.png" class="round_1"></li>
                  <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/img-11.png" class="image_11"></li>
                  <li><img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/images/round-2.png" class="round_2"></li>
                </ul>
